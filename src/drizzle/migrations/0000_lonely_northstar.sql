...
CREATE TYPE "public"."job_listings_type" AS ENUM('full-time', 'part-time', 'contract', 'internship');--> statement-breakpoint
CREATE TYPE "public"."job_listings_location_requirment" AS ENUM('remote', 'on-site', 'hybrid');--> statement-breakpoint
CREATE TYPE "public"."job_listings_wage_interval" AS ENUM('hourly', 'yearly');--> statement-breakpoint
CREATE TYPE "public"."application_stages" AS ENUM('denied', 'applied', 'interested', 'interviews', 'hired');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "job_listings" (
	...
	"locationRequirement" "job_listings_location_requirment" NOT NULL,
...
CREATE TABLE "job_listing_applications" (
	...
	"coverLetter" varchar,
	"rating" integer,
	"stage" "application_stages" NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE INDEX "job_listings_provinceAbbreviation_index" ON "job_listings" USING btree ("provinceAbbreviation");